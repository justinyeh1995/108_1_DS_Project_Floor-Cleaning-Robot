import copy
compare='/Users/mac/Desktop/Data_Structure_NTHU_108-1/Project_2/108_1_DS_Project_Floor-Cleaning-Robot/check0.txt'#input file
fd=open(compare, 'r')
ksk=[]
y=0
...
for i in range(m):
    for j in range(n):
        if( ksk[i][j]=='0'):
            print("not fill ",i,j)
        if(new_list[i][j]=='1' and ksk[i][j]=='2'):
